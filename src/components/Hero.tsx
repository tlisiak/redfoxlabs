...
const Hero = () => {
  return <section className="bg-background py-12 sm:py-16 px-4">
      <div className="max-w-7xl mx-auto">
        {/* Logo */}
        <div className="flex justify-center mb-12 animate-fade-in">
          <img src={logoHorizontal} alt="Red Fox Labs" className="w-64 sm:w-80 md:w-96 h-auto" />
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <img src={foxAnalytics} alt="Red Fox Labs mascot working on analytics" className="w-full max-w-md lg:max-w-lg h-auto" />
          </div>
        </div>
      </div>
    </section>;

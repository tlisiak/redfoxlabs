...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 transition-all duration-400",
  {
    variants: {
      variant: {
        default: "bg-red-fox text-red-fox-foreground hover:bg-red-fox-hover shadow-md",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border-2 border-red-fox bg-transparent text-red-fox hover:bg-red-fox/10",
        secondary:
          "bg-cream text-foreground hover:bg-warm-beige border border-brown-outline/20",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        "red-fox": "bg-red-fox text-red-fox-foreground hover:bg-red-fox-hover shadow-md hover:shadow-glow transition-all",
      },
      size: {

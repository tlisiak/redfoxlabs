...
const WhatIDoContent = () => <div className="space-y-4 text-left">
    <div>
...
const BackgroundContent = () => <div className="space-y-4 text-left">
    <div>
...
const WhyChooseMeContent = () => <div className="space-y-4 text-left">
    <div>
...
const FixedFooter = () => {
  ...
  return <footer className="fixed top-0 sm:bottom-0 sm:top-auto left-0 right-0 z-50 p-4">

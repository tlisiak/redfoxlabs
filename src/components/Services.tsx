  ...
  return <section className="py-20 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {services.map((service, index) => <Card key={index} className="bg-gradient-card border-border shadow-card hover:shadow-glow transition-smooth">
              <CardHeader>
              ...
              <CardContent>
                <ul className="space-y-2">
                  {service.features.map((feature, idx) => <li key={idx} className="flex items-center text-muted-foreground">
